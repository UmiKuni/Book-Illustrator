...
> vitest run
 ...
 ✓ src/App.test.tsx (11 tests) 998ms
 ✓ src/ApplicationFlows.test.tsx (15 tests) 1261ms

 Test Files  2 passed (2)
      Tests  26 passed (26)
   Start at  16:53:31
   Duration  3.31s (transform 267ms, setup 451ms, collect 825ms, tests 2.26s, environment 1.68s, prepare 348ms)
...
> vitest run
 ...
 ✓ tests/pipeline.test.ts (5 tests) 219ms
 ✓ tests/pipeline-reliability.test.ts (6 tests) 235ms
 ✓ tests/health.test.ts (1 test) 71ms
 ✓ tests/style.test.ts (6 tests) 525ms
 ✓ tests/backend-http-completion.test.ts (6 tests) 687ms
 ✓ tests/portraits.test.ts (7 tests) 729ms
 ✓ tests/identity-projects.test.ts (11 tests) 732ms
 ✓ tests/characters.test.ts (11 tests) 832ms
 ✓ tests/illustrations.test.ts (9 tests) 1044ms
 ✓ tests/chapters.test.ts (11 tests) 1065ms

 Test Files  10 passed (10)
      Tests  73 passed (73)
   Start at  16:53:35
   Duration  2.74s (transform 758ms, setup 0ms, collect 8.63s, tests 6.14s, environment 3ms, prepare 2.28s)
```
